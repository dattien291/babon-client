...
const selectBlogStore = (app) => app?.blog;

export const selectComments = createSelector([selectBlogStore], (state) =>
  get(state, 'comments', []),
);

export const selectTotalComments = createSelector([selectBlogStore], (state) =>
  get(state, 'totalComments', 0),
);

export const selectHasMoreComments = createSelector([selectBlogStore], (state) =>
  get(state, 'hasMoreComments', false),
);

export const selectLoadingComments = createSelector([selectBlogStore], (state) =>
  get(state, 'loadingComments', initLoading),
);

export const selectFilter = createSelector([selectBlogStore], (state) => get(state, 'filter'));
